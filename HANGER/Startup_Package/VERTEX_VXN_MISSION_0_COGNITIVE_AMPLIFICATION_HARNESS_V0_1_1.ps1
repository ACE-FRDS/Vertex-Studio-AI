...
<#
VERTEX VXN — MISSION 0 COGNITIVE AMPLIFICATION HARNESS V0.1.1
...
Banner 'VERTEX VXN — MISSION 0 COGNITIVE AMPLIFICATION HARNESS V0.1.1'
...
Banner 'VXN MISSION 0 V0.1.1 — FIRST SIGNAL COMPLETE'
Write-Host "Provider : $($runtime.Provider)"
Write-Host "Model    : $($runtime.Model)"
