...
# ============================================================
# VERTEX - ADAPTIVE GRID EQUIPMENT WORKSPACE V7R8
#
...
$backup=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R8_BACKUP.$stamp"
$failed=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R8_FAILED.$stamp"
$report=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R8.$stamp.json"
...
============================================================
 ...
 PS5.1 COMPAT / RESERVED VARIABLE SAFE
============================================================
