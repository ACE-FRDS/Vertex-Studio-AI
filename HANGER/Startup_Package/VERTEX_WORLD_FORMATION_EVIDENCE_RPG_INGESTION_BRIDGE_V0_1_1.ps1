...
<#
VERTEX WORLD — FORMATION EVIDENCE RPG INGESTION BRIDGE V0.1.1
...
Banner 'VERTEX WORLD — FORMATION EVIDENCE RPG INGESTION BRIDGE V0.1.1'
...
Write-Json $ingestionIndexPath ([ordered]@{
    schema='vertex.world.rpg.formation-evidence-ingestion.v1.1'
...
Write-Json $bridgeReceiptPath ([ordered]@{
    schema='vertex.world.rpg.formation-evidence-ingestion-receipt.v1.1'
