...
# ============================================================
# VERTEX CIC — LIVE SESSION BUS / EDITOR FLIGHT PANEL V10
...
$backup=Join-Path $reports "LIVE_SESSION_BUS_V10_BACKUP.$stamp"
$failed=Join-Path $reports "LIVE_SESSION_BUS_V10_FAILED.$stamp"
$report=Join-Path $reports "LIVE_SESSION_BUS_V10.$stamp.json"
...
Write-Host @'
============================================================
 VERTEX — LIVE SESSION BUS / EDITOR FLIGHT PANEL V10
...
'@
  ...
  [ordered]@{
    schema='vertex.cic.live-session-bus-editor-flight-panel.v10'
  ...
  Write-Host @"
============================================================
 VERTEX — LIVE SESSION BUS V10 GREEN
============================================================
...
"@ -ForegroundColor Green
  ...
  Write-Host ' LIVE SESSION BUS V10 RED — DAMAGE CONTROL' -ForegroundColor Red
