...
# ============================================================
# VERTEX CIC — VERTEXHUB INSTALLER / LOADER V2
...
$backup=Join-Path $reports "VERTEX_HUB_INSTALLER_LOADER_V2_BACKUP.$stamp"
$failed=Join-Path $reports "VERTEX_HUB_INSTALLER_LOADER_V2_FAILED.$stamp"
$report=Join-Path $reports "VERTEX_HUB_INSTALLER_LOADER_V2.$stamp.json"
...
Write-Host @'
============================================================
 VERTEX — VERTEXHUB INSTALLER / LOADER V2
...
'@
  ...
  [ordered]@{
    schema='vertex.cic.vertex-hub-installer-loader.v2'
  ...
  Write-Host @"
============================================================
 VERTEX — VERTEXHUB INSTALLER / LOADER V2 GREEN
============================================================
...
"@ -ForegroundColor Green
  ...
  Write-Host ' VERTEXHUB INSTALLER / LOADER V2 RED — DAMAGE CONTROL' -ForegroundColor Red
