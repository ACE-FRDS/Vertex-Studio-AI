...
# ============================================================
# VERTEX - ADAPTIVE GRID EQUIPMENT WORKSPACE V7R5
#
...
$backup=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R5_BACKUP.$stamp"
$failed=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R5_FAILED.$stamp"
$report=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R5.$stamp.json"
...
============================================================
 ...
 PS5.1 COMPAT / TRANSPORT CONTRACT ADAPTER
============================================================
...
function EnsureBootstrapBase {
  ...
  if(-not(Test-Path -LiteralPath $editorShim)){
    ...
    if($editorSource){
      ...
      $editorAdapter=@"
import * as actual from '$relative'
...
function unbound(name: string): never {
  throw new Error(
    ...
    'V7R5 refused to invent Tauri command names.'
  )
}
