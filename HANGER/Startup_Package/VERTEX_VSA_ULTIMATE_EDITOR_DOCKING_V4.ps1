...
$backup=Join-Path $reports "VSA_EDITOR_V4_BACKUP.$stamp"
$failed=Join-Path $reports "VSA_EDITOR_V4_FAILED.$stamp"
$report=Join-Path $reports "VSA_EDITOR_V4.$stamp.json"
...
Write-Host @'
============================================================
 VERTEX CIC — VSA ULTIMATE EDITOR DOCKING V4
...
"@ -ForegroundColor Green
  ...
  Write-Host "`nV4 RED — DAMAGE CONTROL" -ForegroundColor Red
