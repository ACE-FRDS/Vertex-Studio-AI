...
# ============================================================
# VERTEX CIC — LIVE SESSION BUS / EDITOR FLIGHT PANEL V9
...
$backup=Join-Path $reports "LIVE_SESSION_BUS_V9_BACKUP.$stamp"
$failed=Join-Path $reports "LIVE_SESSION_BUS_V9_FAILED.$stamp"
$report=Join-Path $reports "LIVE_SESSION_BUS_V9.$stamp.json"
...
Write-Host @'
============================================================
 VERTEX — LIVE SESSION BUS / EDITOR FLIGHT PANEL V9
...
'@
  ...
  [ordered]@{
    schema='vertex.cic.live-session-bus-editor-flight-panel.v9'
  ...
  Write-Host @"
============================================================
 VERTEX — LIVE SESSION BUS V9 GREEN
============================================================
...
"@ -ForegroundColor Green
  ...
  Write-Host ' LIVE SESSION BUS V9 RED — DAMAGE CONTROL' -ForegroundColor Red
