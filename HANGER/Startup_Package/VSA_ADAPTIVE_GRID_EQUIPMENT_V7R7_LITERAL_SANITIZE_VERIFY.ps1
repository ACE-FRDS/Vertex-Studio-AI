...
# ============================================================
# VERTEX - ADAPTIVE GRID EQUIPMENT WORKSPACE V7R7
#
...
$backup=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R7_BACKUP.$stamp"
$failed=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R7_FAILED.$stamp"
$report=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R7.$stamp.json"
...
============================================================
 ...
 PS5.1 COMPAT / LITERAL SANITIZE + VERIFY
============================================================
...
function unbound(name: string): never {
  throw new Error(
    ...
    'V7R7 refused to invent Tauri command names.'
  )
}
