...
<#
VERTEX WORLD — RPG SYNERGY & AFFINITY ENGINE V0.1.0
...
Banner 'VERTEX WORLD — RPG SYNERGY & AFFINITY ENGINE V0.1.0'
...
$index = [ordered]@{
    schema='vertex.world.rpg.synergy-affinity-index.v1'
...
$summary = [ordered]@{
    schema='vertex.world.rpg.synergy-summary.v1'
    updated_at=(Get-Date).ToString('o')
    best_role=$bestRole
    best_pair=$bestPair
...
Write-Json $receiptPath ([ordered]@{
    schema='vertex.world.rpg.synergy-affinity-engine-receipt.v1'
