...
# ============================================================
# VERTEX - ADAPTIVE GRID EQUIPMENT WORKSPACE V7R6
#
...
$backup=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R6_BACKUP.$stamp"
$failed=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R6_FAILED.$stamp"
$report=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R6.$stamp.json"
...
============================================================
 ...
 PS5.1 COMPAT / LITERAL HERE-STRING SAFE ADAPTER
============================================================
...
function unbound(name: string): never {
  throw new Error(
    ...
    'V7R6 refused to invent Tauri command names.'
  )
}
...
# Repair a malformed adapter left behind by V7R5 before any baseline build.
if(Test-Path -LiteralPath $editorShim){
  ...
  Write-Host '  Existing generated adapter     : SANITIZED' -ForegroundColor Green
}
