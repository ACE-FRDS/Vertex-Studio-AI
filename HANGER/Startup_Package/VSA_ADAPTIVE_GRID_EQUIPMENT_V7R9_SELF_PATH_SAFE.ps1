...
# ============================================================
# VERTEX - ADAPTIVE GRID EQUIPMENT WORKSPACE V7R9
#
...
$backup=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R9_BACKUP.$stamp"
$failed=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R9_FAILED.$stamp"
$report=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R9.$stamp.json"
