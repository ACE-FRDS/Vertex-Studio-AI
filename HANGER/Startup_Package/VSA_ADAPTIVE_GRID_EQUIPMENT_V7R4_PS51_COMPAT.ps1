...
# ============================================================
# VERTEX - ADAPTIVE GRID EQUIPMENT WORKSPACE V7R4
#
...
$backup=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R4_BACKUP.$stamp"
$failed=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R4_FAILED.$stamp"
$report=Join-Path $reports "VSA_ADAPTIVE_GRID_V7R4.$stamp.json"
...
function unbound(name: string): never {
  throw new Error(
    ...
    'V7R4 refused to invent Tauri command names.'
  )
}
