...
function Diagnose {
    ...
    if ($RetryCount -ge 2 -and ($Eval.Schema -lt 1.0 -or $Eval.Lock -lt 1.0 -or $Eval.Scope -lt 1.0 -or $d.Contains('ASSOCIATION_STARVED'))) {
        $d.Add('MODEL_STARVED')
    }
...
Banner 'VERTEX BOOSTER — LIVE THROTTLE EXPERIMENT V0.1.2'
...
$receipt = [ordered]@{
    schema='vertex.booster.live-throttle-experiment.v1.2'
    run_id=$runId
