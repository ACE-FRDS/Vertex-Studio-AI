...
# ============================================================
# VERTEX - VSA ROLE LAYOUT REBUILD V5
#
...
$backup=Join-Path $reports "VSA_ROLE_LAYOUT_REBUILD_V5_BACKUP.$stamp"
$failed=Join-Path $reports "VSA_ROLE_LAYOUT_REBUILD_V5_FAILED.$stamp"
$report=Join-Path $reports "VSA_ROLE_LAYOUT_REBUILD_V5.$stamp.json"
...
'@
  ...
  [ordered]@{
    schema='vertex.cic.role-layout.v5'
    timestamp=(Get-Date).ToString('o')
    status='GREEN'
    mission='VSA ROLE LAYOUT REBUILD V5'
    roles=[ordered]@{
      left='HYPERAGENT CHAT / HUMAN INTENT GATEWAY'
  ...
  Write-Host @"
============================================================
 VERTEX - VSA ROLE LAYOUT REBUILD V5 GREEN
============================================================
...
"@ -ForegroundColor Green
  ...
  Write-Host ' VSA ROLE LAYOUT REBUILD V5 RED - DAMAGE CONTROL' -ForegroundColor Red
