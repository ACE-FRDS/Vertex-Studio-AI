...
<#
VERTEX ENV-2 V2.4.7 — FINAL REMEDIATION GATE
...
Write-Host ' VERTEX ENV-2 V2.4.7 — FINAL REMEDIATION GATE' -ForegroundColor Magenta
...
$report = [ordered]@{
    ...
    mission = 'VERTEX_ENV_2_V2_4_7_FINAL_REMEDIATION_GATE'
